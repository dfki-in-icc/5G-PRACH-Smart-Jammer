...
#define CONFIG_HLP_STATS_ENABLE  "activation globally for the stats generation and persistence"
...
#define CMDLINE_PARAMS_DESC {  \
    ...
    {"enable-stats",         CONFIG_HLP_STATS_ENABLE, PARAMFLAG_BOOL, iptr:&stats_enabled,                 defintval:0,           TYPE_INT,    0},                     \
  }
...
#define SOFTMODEM_STATS_BIT           (1<<24)
...
#define IS_SOFTMODEM_STATS_BIT       ( get_softmodem_optmask() & SOFTMODEM_STATS_BIT)

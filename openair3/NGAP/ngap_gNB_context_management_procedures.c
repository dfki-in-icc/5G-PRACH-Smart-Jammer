                                     ...
                                     ngap_ue_release_complete_t *ue_release_complete_p)
{
  ...
  if ((ue_context_p = ngap_gNB_get_ue_context(ue_release_complete_p->gNB_ue_ngap_id)) == NULL) {
  ...
  // release UE context
  ngap_gNB_free_ue_context(ue_release_complete_p->gNB_ue_ngap_id);
                                ...
                                ngap_ue_release_req_t *ue_release_req_p)
{
  ...
  if ((ue_context_p = ngap_gNB_get_ue_context(ue_release_req_p->gNB_ue_ngap_id)) == NULL) {
    /* The context for this gNB ue ngap id doesn't exist in the map of gNB UEs */
    NGAP_WARN("Failed to find ue context associated with gNB ue ngap id: %u\n",

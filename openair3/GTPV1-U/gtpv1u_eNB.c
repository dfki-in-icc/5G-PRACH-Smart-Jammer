...
#if LATSEQ
        LATSEQ_P("D ip--pdcp.in.gtp", "len%d:drb%d.rnti%d.fm%d:gsn%d", buffer_len, gtpv1u_teid_data_p->eps_bearer_id - 4, gtpv1u_teid_data_p->ue_id, ctxt.frame, RC.gtpv1u_data_g->seq_num);
#endif

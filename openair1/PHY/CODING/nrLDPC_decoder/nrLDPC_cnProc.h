                                        ...
                                        t_nrLDPC_time_stats* p_profiler)
{
  ...
  // CN group with 3 BNs
    ...
    p_profiler->bn2cnProcBuf.trials--; // becasuse we see CNG proc as one trial
#endif
  ...
  if (lut_numCnInCnGroups[0] > 0)
  {
    ...
    p_profiler->cn2bnProcBuf.trials--;
#endif
...
static inline void nrLDPC_layerProc_BG1(t_nrLDPC_lut* p_lut,
                                        int8_t* llr,
                                        int8_t* llrProcBuf,
                                        int8_t* llrRes,
                                        int8_t* cnProcBuf,

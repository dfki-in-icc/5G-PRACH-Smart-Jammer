                        ...
                        uint8_t  symbol)
{
...
#elif defined(__arm__) || defined(__aarch64__)
  int16x8_t *ulsch_llr=(int16_t*)ulsch_llr;
  int16x8_t *rxF = (int16x8_t*)&rxdataF_comp;
  ...
  for (i=0; i<nb_re; i++) {
    ...
    // ---------------------------------------
#if defined(__x86_64__) || defined(__i386__)
    ulsch_llr32[0] = simde_mm256_extract_epi32(xmm0,1);
    ulsch_llr32[1] = simde_mm256_extract_epi32(xmm1,1);
    ulsch_llr32[2] = simde_mm256_extract_epi32(xmm2,1);
    ulsch_llr32+=3;
#elif defined(__arm__) || defined(__aarch64__)
    ...
    // ---------------------------------------
#if defined(__x86_64__) || defined(__i386__)
    ulsch_llr32[0] = simde_mm256_extract_epi32(xmm0,2);
    ulsch_llr32[1] = simde_mm256_extract_epi32(xmm1,2);
    ulsch_llr32[2] = simde_mm256_extract_epi32(xmm2,2);
    ulsch_llr32+=3;
#elif defined(__arm__) || defined(__aarch64__)
    ...
    // ---------------------------------------
#if defined(__x86_64__) || defined(__i386__)
    ulsch_llr32[0] = simde_mm256_extract_epi32(xmm0,3);
    ulsch_llr32[1] = simde_mm256_extract_epi32(xmm1,3);
    ulsch_llr32[2] = simde_mm256_extract_epi32(xmm2,3);
    ulsch_llr32+=3;
#elif defined(__arm__) || defined(__aarch64__)
    ...
    ulsch_llr32[0] = simde_mm256_extract_epi32(xmm0,4);
    ulsch_llr32[1] = simde_mm256_extract_epi32(xmm1,4);
    ulsch_llr32[2] = simde_mm256_extract_epi32(xmm2,4);

    ulsch_llr32[3] = simde_mm256_extract_epi32(xmm0,5);
    ulsch_llr32[4] = simde_mm256_extract_epi32(xmm1,5);
    ulsch_llr32[5] = simde_mm256_extract_epi32(xmm2,5);

    ulsch_llr32[6] = simde_mm256_extract_epi32(xmm0,6);
    ulsch_llr32[7] = simde_mm256_extract_epi32(xmm1,6);
    ulsch_llr32[8] = simde_mm256_extract_epi32(xmm2,6);

    ulsch_llr32[9]  = simde_mm256_extract_epi32(xmm0,7);
    ulsch_llr32[10] = simde_mm256_extract_epi32(xmm1,7);
    ulsch_llr32[11] = simde_mm256_extract_epi32(xmm2,7);

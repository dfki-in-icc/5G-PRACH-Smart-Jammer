...
int rx_slsss(PHY_VARS_UE *ue,int32_t *tot_metric,uint8_t *phase_max,int Nid2)
{
  ...
  slpss_sss_extract(ue,
    ...
    LOG_M("rxdataF0.m","rxF0",&rxdataF[0][0],2*14*ue->frame_parms.ofdm_symbol_size,1,1);
    LOG_M("pss0_ext.m","pss0ext",pss0_ext,72,1,1);
    LOG_M("sss0_ext.m","sss0ext",sss0_ext,72,1,1);
    LOG_M("pss1_ext.m","pss1ext",pss1_ext,72,1,1);
    LOG_M("sss1_ext.m","sss1ext",sss1_ext,72,1,1); 
  ...
  for (i=0;i<144;i++) {
    ...
    LOG_M("sss0_comp0.m","sss0comp0",sss0_comp16,72,1,1);
    LOG_M("sss1_comp0.m","sss1comp0",sss1_comp16,72,1,1);
    //exit(-1); 

...
void nr_common_signal_procedures (PHY_VARS_gNB *gNB,int frame,int slot,nfapi_nr_dl_tti_ssb_pdu ssb_pdu) {
  ...
  fp->ssb_start_subcarrier = (12 * cfg->ssb_table.ssb_offset_point_a.value + (ssb_pdu.ssb_pdu_rel15.SsbSubcarrierOffset>>cfg->ssb_config.scs_common.value));
  LOG_I(PHY, "SSB first subcarrier %d (%d,%d)\n", fp->ssb_start_subcarrier,cfg->ssb_table.ssb_offset_point_a.value,ssb_pdu.ssb_pdu_rel15.SsbSubcarrierOffset>>cfg->ssb_config.scs_common.value);

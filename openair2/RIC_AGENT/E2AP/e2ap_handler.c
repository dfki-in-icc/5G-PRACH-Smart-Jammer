        ...
        uint32_t *outlen)
{
            ...
            ptr++) 
    {
        ...
        if  (connUpdateIE->value.present == E2AP_E2connectionUpdate_IEs__value_PR_E2connectionUpdate_List) 
        {
            ...
            if (connUpdate_Item->value.present == E2AP_E2connectionUpdate_ItemIEs__value_PR_E2connectionUpdate_Item)
            {
                ...
                // TODO RIC: handle CU DU
                if ((e2_conf[ranid]->e2node_type ==  E2NODE_TYPE_GNB_CU) || (e2_conf[ranid]->e2node_type == E2NODE_TYPE_ENB_CU))
                {
    ...
    // Comment out if testing with loopback
                ...
                strncpy(req->local_address.ipv4_address, e2_conf[ranid]->local_ipv4_addr, // TODO RIC: variable
...
{
    //RIC TODO: handle control response

...
//	 }
 ...
 void nr_rrc_ue_generate_RRCSetupRequest(module_id_t module_id, const uint8_t gNB_index) {
   ...
   if(1/*NR_UE_rrc_inst[module_id].Srb0[gNB_index].Tx_buffer.payload_size ==0*/) {
 ...
 void *rrc_nrue_task( void *args_p ) {
   ...
   while(1) {
	...
	NR_UE_rrc_inst[ue_mod_id].SRB2_config[0] = NULL;
        NR_UE_rrc_inst[ue_mod_id].DRB_config[0][0]=NULL;
        NR_UE_rrc_inst[ue_mod_id].DRB_config[0][4]=NULL;
        NR_UE_rrc_inst[ue_mod_id].defaultDRB=NULL;
...
/*int test_uecapa_size=420;
char test_uecapa[420]=
{};*/
int test_uecapa_size=462;
char test_uecapa[462]=
{};
//-----------------------------------------------------------------------------
void
nr_rrc_ue_process_ueCapabilityEnquiry(
  const protocol_ctxt_t *const ctxt_pP,
...
//-----------------------------------------------------------------------------
{
  ...
  for (i=0; i<UECapabilityEnquiry->criticalExtensions.choice.ueCapabilityEnquiry->ue_CapabilityRAT_RequestList.list.count; i++) {
    if (UECapabilityEnquiry->criticalExtensions.choice.ueCapabilityEnquiry->ue_CapabilityRAT_RequestList.list.array[i]->rat_Type
      ...
      enc_rval = uper_encode_to_buffer(&asn_DEF_NR_UL_DCCH_Message, NULL, (void *) &ul_dcch_msg, buffer, 1000);
      AssertFatal (enc_rval.encoded > 0, "ASN1 message encoding failed (%s, %jd)!\n",
                   enc_rval.failed_type->name, enc_rval.encoded);

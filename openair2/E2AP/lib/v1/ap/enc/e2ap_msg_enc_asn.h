...
struct E2AP_E2AP_PDU* e2ap_enc_subscription_failure_asn_pdu(const ric_subscription_failure_t* sf);
...
struct E2AP_E2AP_PDU* e2ap_enc_subscription_delete_request_asn_pdu(const ric_subscription_delete_request_t* dr);
...
struct E2AP_E2AP_PDU* e2ap_enc_subscription_delete_response_asn_pdu(const ric_subscription_delete_response_t* dr);
...
struct E2AP_E2AP_PDU* e2ap_enc_subscription_delete_failure_asn_pdu(const ric_subscription_delete_failure_t* df);
...
struct E2AP_E2AP_PDU* e2ap_enc_indication_asn_pdu(const ric_indication_t* ind);
...
struct E2AP_E2AP_PDU* e2ap_enc_control_request_asn_pdu(const ric_control_request_t* ric_req);
...
struct E2AP_E2AP_PDU* e2ap_enc_control_ack_asn_pdu(const ric_control_acknowledge_t* ca);
...
struct E2AP_E2AP_PDU* e2ap_enc_control_failure_asn_pdu(const ric_control_failure_t* cf);
...
struct E2AP_E2AP_PDU* e2ap_enc_error_indication_asn_pdu(const e2ap_error_indication_t* ei);
...
struct E2AP_E2AP_PDU* e2ap_enc_setup_request_asn_pdu(const e2_setup_request_t* sr);
...
struct E2AP_E2AP_PDU* e2ap_enc_setup_failure_asn_pdu(const e2_setup_failure_t* sf);
...
struct E2AP_E2AP_PDU* e2ap_enc_reset_request_asn_pdu(const e2ap_reset_request_t* rr);
...
struct E2AP_E2AP_PDU* e2ap_enc_reset_response_asn_pdu(const e2ap_reset_response_t* rr);
...
struct E2AP_E2AP_PDU* e2ap_enc_service_update_asn_pdu(const ric_service_update_t* su);
...
struct E2AP_E2AP_PDU* e2ap_enc_service_update_ack_asn_pdu(const ric_service_update_ack_t* su);
...
struct E2AP_E2AP_PDU* e2ap_enc_service_update_failure_asn_pdu(const ric_service_update_failure_t* uf);
...
struct E2AP_E2AP_PDU* e2ap_enc_node_configuration_update_ack_asn_pdu(const e2_node_configuration_update_ack_t* cua);
...
struct E2AP_E2AP_PDU* e2ap_enc_node_configuration_update_failure_asn_pdu(const e2_node_configuration_update_failure_t* cuf);
...
struct E2AP_E2AP_PDU* e2ap_enc_node_connection_update_asn_pdu(const e2_node_connection_update_t* cu);
...
struct E2AP_E2AP_PDU* e2ap_enc_node_connection_update_ack_asn_pdu(const e2_node_connection_update_ack_t* ca);
...
struct E2AP_E2AP_PDU* e2ap_enc_node_connection_update_failure_asn_pdu(const e2_node_connection_update_failure_t*);
...
struct E2AP_E2AP_PDU* e2ap_enc_e42_subscription_request_asn_pdu(const e42_ric_subscription_request_t* sr);
...
struct E2AP_E2AP_PDU* e2ap_enc_e42_subscription_delete_request_asn_pdu(const e42_ric_subscription_delete_request_t* e42_sr);
...
struct E2AP_E2AP_PDU* e2ap_enc_e42_control_request_asn_pdu(const e42_ric_control_request_t* ric_req);

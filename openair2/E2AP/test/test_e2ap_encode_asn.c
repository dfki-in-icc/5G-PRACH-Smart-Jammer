...
static void try_encode(E2AP_E2AP_PDU_t* pdu)
{
  assert(pdu != NULL);
  uint8_t buffer[2048];
...
void test_ric_subscription_request()
{
  ...
  ric_subscription_request_t sr_before = {.ric_id = ric_id, .event_trigger = ba_event_trigger, .action = action, .len_action = len_action};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_request_asn_pdu(&sr_before);
...
void test_ric_subscription_response()
{
  ...
  ric_subscription_response_t sr = {.ric_id = ric_id, .admitted = admitted, .len_admitted = len_admitted, .not_admitted = not_admitted, .len_na = len_na};
...
void test_ric_subscription_delete_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_delete_failure_asn_pdu(&dr);
...
void test_ric_indication()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_indication_asn_pdu(&ric_ind);
...
void test_e2_setup_request()
{
  ...
  e2_setup_request_t e2_stp_req = {.id = id, .ran_func_item = ran_func_item, .len_rf = len_rf, .comp_conf_update = comp_conf_update, .len_ccu = len_ccu};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_setup_request_asn_pdu(&e2_stp_req);
...
void test_e2_setup_response()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_setup_response_asn_pdu(&e2_stp_res);
...
void test_ric_control_request()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_control_request_asn_pdu(&rcr);
...
void test_ric_control_ack()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_control_ack_asn_pdu(&c_ack);
...
void test_e2_node_connection_update_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_node_connection_update_failure_asn_pdu(&cf);

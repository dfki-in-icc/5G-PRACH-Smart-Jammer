...
#include "lib/v1/ap/enc/e2ap_msg_enc_asn.h"
#include "lib/v1/ap/dec/e2ap_msg_dec_asn.h"
#include "lib/v1/ap/free/e2ap_msg_free.h"

void try_encode(E2AP_E2AP_PDU_t* pdu)
{
  assert(pdu != NULL);
  uint8_t buffer[2048];
  ...
  asn_enc_rval_t er = asn_encode_to_buffer(NULL, syntax, &asn_DEF_E2AP_E2AP_PDU, pdu, buffer, 2048);
...
void test_subscription_request()
{
  ...
  ric_subscription_request_t sr_begin = {.ric_id = ric_id, .event_trigger = ba_event_trigger, .action = action, .len_action = len_action};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_request_asn_pdu(&sr_begin);
...
void test_subscription_response()
{
  ...
  ric_subscription_response_t sr_begin = {.ric_id = ric_id, .admitted = admitted, .len_admitted = len_admitted, .not_admitted = not_admitted, .len_na = len_na};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_response_asn_pdu(&sr_begin);
...
void test_subscription_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_failure_asn_pdu(&sf_begin);
...
void test_subscription_delete_request()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_delete_request_asn_pdu(&dr_begin);
...
void test_ric_subscription_delete_response()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_delete_response_asn_pdu(&dr_begin);
...
void test_subscription_delete_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_subscription_delete_failure_asn_pdu(&dr_begin);
...
void test_indication()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_indication_asn_pdu(&ind_begin);
...
void test_control_request()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_control_request_asn_pdu(&rcr_begin);
...
void test_control_request_ack()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_control_ack_asn_pdu(&c_ack_begin);
...
void test_control_request_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_control_failure_asn_pdu(&cf_begin);
...
void test_error_indication()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_error_indication_asn_pdu(&ei_begin);
...
void test_setup_rquest()
{
  ...
  e2_setup_request_t e2_stp_req_begin = {.id = id, .ran_func_item = ran_func_item, .len_rf = len_rf, .comp_conf_update = comp_conf_update, .len_ccu = len_ccu};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_setup_request_asn_pdu(&e2_stp_req_begin);
...
void test_setup_response()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_setup_response_asn_pdu(&e2_stp_res_begin);
...
void test_setup_failure()
{
  ...
  *time_to_wait_ms = TIMETOWAIT_V1S;
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_setup_failure_asn_pdu(&sf_begin);
...
void test_reset_request()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_reset_request_asn_pdu(&rr_begin);
...
void test_reset_response()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_reset_response_asn_pdu(&rr_begin);
...
void test_service_update()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_service_update_asn_pdu(&su_begin);
...
void test_service_update_ack()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_service_update_ack_asn_pdu(&su_begin);
...
void test_service_update_failure()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_service_update_failure_asn_pdu(&uf_begin);
...
void test_service_query()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_service_query_asn_pdu(&sq_begin);
...
void test_node_configuration_update()
{
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_node_configuration_update_asn_pdu(&cu_begin);
...
static inline void fill_ran_function(ran_function_t* rf)
{
  assert(rf != NULL);
...
void test_e42_setup_request()
{
  ...
  e42_setup_request_t sr_begin = {.len_rf = r};
  ...
  */
  ...
  E2AP_E2AP_PDU_t* pdu = e2ap_enc_e42_setup_request_asn_pdu(&sr_begin);
  e2ap_msg_t msg = e2ap_dec_e42_setup_request(pdu);
  free_pdu(pdu);
...
static void test_e42_subscription_request()
{
  plmn_t plmn = {.mcc = 10, .mnc = 15, .mnc_digit_len = 2};
  ...
  ric_subscription_request_t sr = {.ric_id = ric_id, .event_trigger = ba_event_trigger, .action = action, .len_action = len_action};

  e42_ric_subscription_request_t e42_sr_begin = {.xapp_id = 13, .id = id, .sr = sr};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_e42_subscription_request_asn_pdu(&e42_sr_begin);
...
static void test_e42_subscription_delete_request()
{
  const ric_gen_id_t ric_id = {.ric_req_id = 0, .ric_inst_id = 2, .ran_func_id = 12};
  ...
  e42_ric_subscription_delete_request_t e42_sdr_begin = {.xapp_id = 13, .sdr = dr_begin};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_e42_subscription_delete_request_asn_pdu(&e42_sdr_begin);
...
static void test_e42_control_request()
{
  plmn_t plmn = {.mcc = 10, .mnc = 15, .mnc_digit_len = 2};
  ...
  e42_ric_control_request_t rcr_begin = {.xapp_id = 7, .id = id, .ctrl_req = rcr};

  E2AP_E2AP_PDU_t* pdu = e2ap_enc_e42_control_request_asn_pdu(&rcr_begin);

  const byte_array_t ba = e2ap_enc_asn_pdu_ba(pdu);
  free_pdu(pdu);

  E2AP_E2AP_PDU_t* pdu2 = e2ap_create_pdu(ba.buf, ba.len);
  free_byte_array(ba);

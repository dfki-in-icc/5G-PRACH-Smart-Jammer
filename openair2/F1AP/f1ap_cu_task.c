...
printf("cu_task_create_gtpu_instance_to_du %s %s %d %d\n", IPaddrs->my_addr, IPaddrs->remote_addr, IPaddrs->my_portd, IPaddrs->remote_portd);
...
static void cu_task_handle_sctp_association_ind(
    instance_t instance,

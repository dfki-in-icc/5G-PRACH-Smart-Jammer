...
int DU_handle_DL_RRC_MESSAGE_TRANSFER(instance_t       instance,
  ...
  LOG_D(F1AP, "du_ue_f1ap_id %lu associated with UE RNTI %x \n",
        du_ue_f1ap_id,
        f1ap_get_rnti_by_du_id(DUtype, instance, du_ue_f1ap_id, 0));
  ...
  ctxt.rnti      = f1ap_get_rnti_by_du_id(DUtype, instance, du_ue_f1ap_id, 0);
  ...
  if (srb_id == 0) {
    ...
    switch (dl_ccch_msg->message.choice.c1.present) {
      ...
      case LTE_DL_CCCH_MessageType__c1_PR_rrcConnectionSetup: {
        ...
        rnti_t rnti = f1ap_get_rnti_by_du_id(DUtype, instance, du_ue_f1ap_id, 0);
...
int DU_handle_DL_NR_RRC_MESSAGE_TRANSFER(instance_t       instance,
  ...
  f1ap_dl_rrc_message_t dl_rrc = {
    ...
    .rnti = f1ap_get_rnti_by_du_id(DUtype, instance, du_ue_f1ap_id, 0),
    .srb_id = srb_id
  };
  ...
  req->rnti=f1ap_get_rnti_by_du_id(DUtype, instance, du_ue_f1ap_id, 0);
  req->srb_id=srb_id;

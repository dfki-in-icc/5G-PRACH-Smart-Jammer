  ...
  while (1) {
    ...
    switch (ITTI_MSG_ID(msg)) {
      case F1AP_SETUP_REQ:
        ...
        getCxt(DUtype, myInstance)->gtpInst=du_create_gtpu_instance_to_cu("172.21.6.9", //msgSetup->CU_f1_ip_address.ipv4_address, //"172.21.6.9", //"172.21.10.9",//"172.21.9.5", //msgSetup->CU_f1_ip_address.ipv4_address, //"192.168.18.91"
                                            msgSetup->CUport,

...
FL_EXPORT int fl_is_inside_lalign( int align ){return 0;};

FL_EXPORT int fl_is_outside_lalign( int align ){return 0;};

FL_EXPORT int fl_is_center_lalign( int align ){return 0;};

FL_EXPORT int fl_to_inside_lalign( int align ){return 0;};

FL_EXPORT int fl_to_outside_lalign( int align ){return 0;};
...
FL_EXPORT int fl_input_end_return_handling( int type ){return 0;};
...
FL_EXPORT long fl_library_full_version( int         * version,
										int         * revision,
										int         * fix_level,
										const char ** extra ){return 0;};

/** Generic routines that deal with FORMS **/

FL_EXPORT FL_FORM * fl_bgn_form( int      type,
                                 FL_Coord w,
                                 FL_Coord h ){return NULL;};

FL_EXPORT void fl_end_form( void ){};

FL_EXPORT FL_OBJECT * fl_do_forms( void ){return NULL;};

FL_EXPORT FL_OBJECT * fl_check_forms( void ){return NULL;};

FL_EXPORT FL_OBJECT * fl_do_only_forms( void ){return NULL;};

FL_EXPORT FL_OBJECT * fl_check_only_forms( void ){return NULL;};
...
FL_EXPORT FL_OBJECT *fl_get_focus_object( FL_FORM * form ){return NULL;};
...
FL_EXPORT FL_FORM * fl_get_app_mainform( void ){return NULL;};
...
FL_EXPORT Window fl_show_form_window( FL_FORM * form ){return NULL;};

FL_EXPORT double fl_adjust_form_size( FL_FORM * form ){return 0;};

FL_EXPORT int fl_form_is_visible( FL_FORM * form ){return 0;};

FL_EXPORT int fl_form_is_iconified( FL_FORM * form ){return 0;};
...
FL_EXPORT FL_OBJECT * fl_bgn_group( void ){return NULL;};

FL_EXPORT void fl_end_group( void ){};

FL_EXPORT FL_OBJECT *fl_addto_group( FL_OBJECT * group ){return NULL;};


/****** Routines that deal with FL_OBJECTS ********/

FL_EXPORT int fl_get_object_objclass( FL_OBJECT * obj ){return 0;};

FL_EXPORT int fl_get_object_type( FL_OBJECT * obj ){return 0;};

FL_EXPORT void fl_set_object_boxtype( FL_OBJECT * ob,
                                      int         boxtype ){};

FL_EXPORT int fl_get_object_boxtype( FL_OBJECT * obj ){return 0;};

FL_EXPORT void fl_set_object_bw( FL_OBJECT * ob,
                                 int         bw ){};

FL_EXPORT int fl_get_object_bw( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_object_lstyle( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_get_object_lalign( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT const char * fl_get_object_label( FL_OBJECT * obj ){return NULL;};
...
FL_EXPORT unsigned long fl_get_object_dblclick( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_get_object_return_state( FL_OBJECT *obj ){return 0;};
...
FL_EXPORT int fl_object_is_active( FL_OBJECT * obj ){return 0;};

FL_EXPORT int fl_enumerate_fonts( void ( * output )( const char * s ),
                                  int  shortform ){return 0;};
...
FL_EXPORT int fl_get_label_char_at_mouse( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_add_symbol( const char * name,
                             FL_DRAWPTR   drawit,
                             int          scalable ){return 0;};

FL_EXPORT int fl_delete_symbol( const char * name ){return 0;};
...
FL_EXPORT unsigned long fl_get_pixel( FL_COLOR col ){return 0;};
...
FL_EXPORT FL_FORM *fl_addto_form( FL_FORM * form ){return NULL;};
...
FL_EXPORT FL_OBJECT * fl_make_object( int            objclass,
                                      ...
                                      FL_Coord       h,
                                      const char   * label,
                                      FL_HANDLEPTR   handle ){return NULL;};

FL_EXPORT void fl_add_child( FL_OBJECT *oa,
                             FL_OBJECT *ob ){};
...
FL_EXPORT int fl_get_coordunit( void ){return 0;};

FL_EXPORT int fl_get_border_width( void ){return 0;};
...
FL_EXPORT const char * fl_now( void ){return NULL;};

FL_EXPORT const char * fl_whoami( void ){return NULL;};

FL_EXPORT long fl_mouse_button( void ){return 0;};

FL_EXPORT int fl_current_event( void ){return 0;};

FL_EXPORT char * fl_strdup( const char * s ){return NULL;};

FL_EXPORT void fl_set_err_logfp( FILE * fp ){};

FL_EXPORT void fl_set_error_handler( FL_ERROR_FUNC user_func ){};

FL_EXPORT char ** fl_get_cmdline_args( int * ia ){return NULL;};
...
FL_EXPORT void * ( * fl_realloc )( void *,
                                   size_t ){};
*/
FL_EXPORT int fl_msleep( unsigned long msec ){return 0;};
...
FL_EXPORT int fl_get_linewidth( void ){return 0;};

FL_EXPORT int fl_get_linestyle( void ){return 0;};

FL_EXPORT int fl_get_drawmode( void ){return 0;};
...
FL_EXPORT Window fl_get_mouse( FL_Coord  * x,
                               FL_Coord  * y,
                               unsigned int * keymask ){return NULL;};
...
FL_EXPORT FL_FORM * fl_win_to_form( Window win ){return NULL;};
...
FL_EXPORT Window fl_wincreate( const char * label ){return NULL;};

FL_EXPORT Window fl_winshow( Window win ){return NULL;};

FL_EXPORT Window fl_winopen( const char * label ){return NULL;};
...
FL_EXPORT int fl_winreparent( Window win,
                              Window new_parent ){return 0;};

FL_EXPORT void fl_winfocus( Window win ){};

FL_EXPORT Window fl_winget( void ){return NULL;};

FL_EXPORT int fl_iconify( Window win ){return 0;};
...
FL_EXPORT int fl_winisvalid( Window win ){return 0;};
...
FL_EXPORT int fl_XNextEvent( XEvent * xev ){return 0;};

FL_EXPORT int fl_XPeekEvent( XEvent * xev ){return 0;};

FL_EXPORT int fl_XEventsQueued( int mode ){return 0;};

FL_EXPORT void fl_XPutBackEvent( XEvent * xev ){};

FL_EXPORT const XEvent *fl_last_event( void ){return NULL;};
...
FL_EXPORT int fl_keysym_pressed( KeySym k ){return 0;};
...
FL_EXPORT int fl_get_visual_depth( void ){return 0;};

FL_EXPORT int fl_is_global_clipped( void ){return 0;};

FL_EXPORT int fl_is_clipped( int include_global ){return 0;};

FL_EXPORT int fl_is_text_clipped( int include_global ){return 0;};
...
FL_EXPORT FL_POPUP *fl_popup_add( Window W1,
                                  const char *c1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_add_entries( FL_POPUP *P1,
                                                const char *c1,
                                                ... ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_insert_entries( FL_POPUP *P1,
                                                   FL_POPUP_ENTRY *PE1,
                                                   const char *c1,
                                                   ... ){return NULL;};

FL_EXPORT FL_POPUP *fl_popup_create( Window W1,
                                     const char *c1,
                                     FL_POPUP_ITEM *PI1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_add_items( FL_POPUP      *P1,
											  FL_POPUP_ITEM *PI1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_insert_items( FL_POPUP       *P1,
												 FL_POPUP_ENTRY *PE1,
												 FL_POPUP_ITEM  *PI1 ){return NULL;};

FL_EXPORT int fl_popup_delete( FL_POPUP *P1 ){return 0;};

FL_EXPORT int fl_popup_entry_delete( FL_POPUP_ENTRY *P1 ){return 0;};

FL_EXPORT FL_POPUP_RETURN *fl_popup_do( FL_POPUP *P1 ){return NULL;};

FL_EXPORT void fl_popup_set_position( FL_POPUP *P1,
                                      int i1,
                                      int i2){};

FL_EXPORT int fl_popup_get_policy( FL_POPUP *P1 ){return 0;};

FL_EXPORT int fl_popup_set_policy( FL_POPUP *P1,
                                   int i1){return 0;};

FL_EXPORT FL_POPUP_CB fl_popup_set_callback( FL_POPUP *P1,
                                             FL_POPUP_CB CF1){};

FL_EXPORT void fl_popup_get_title_font( FL_POPUP *P1,
                                        int *i1,
                                        int *i2 ){};

FL_EXPORT void fl_popup_set_title_font( FL_POPUP *P1,
                                        int i1,
                                        int i2){};

FL_EXPORT void fl_popup_entry_get_font( FL_POPUP *P1,
                                        int *i1,
                                        int *i2 ){};

FL_EXPORT void fl_popup_entry_set_font( FL_POPUP *P1,
                                        int i1,
                                        int i2){};

FL_EXPORT int fl_popup_get_bw( FL_POPUP *P1 ){return 0;};

FL_EXPORT int fl_popup_set_bw( FL_POPUP *P1,
                               int i1){return 0;};

FL_EXPORT FL_COLOR fl_popup_get_color( FL_POPUP *P1,
                                       int i1){};

FL_EXPORT FL_COLOR fl_popup_set_color( FL_POPUP *P1,
                                       int i1,
                                       FL_COLOR C1){};

FL_EXPORT void fl_popup_set_cursor( FL_POPUP *P1,
                                    int i1){};

FL_EXPORT const char *fl_popup_get_title( FL_POPUP   *P1 ){return NULL;};

FL_EXPORT FL_POPUP *fl_popup_set_title( FL_POPUP *P1,
                                        const char *c1 ){return NULL;};
...
FL_EXPORT FL_POPUP_CB fl_popup_entry_set_callback( FL_POPUP_ENTRY *P1,
                                                   FL_POPUP_CB CF1){return NULL;};

FL_EXPORT FL_POPUP_CB fl_popup_entry_set_enter_callback( FL_POPUP_ENTRY *P1,
                                                         FL_POPUP_CB CF1){return NULL;};

FL_EXPORT FL_POPUP_CB fl_popup_entry_set_leave_callback( FL_POPUP_ENTRY *P1,
                                                         FL_POPUP_CB CF1){return NULL;};

FL_EXPORT unsigned int fl_popup_entry_get_state( FL_POPUP_ENTRY *P1 ){return 0;};

FL_EXPORT unsigned int fl_popup_entry_set_state( FL_POPUP_ENTRY *P1,
                                                 unsigned int i1){return 0;};

FL_EXPORT unsigned int fl_popup_entry_clear_state( FL_POPUP_ENTRY *P1,
                                                   unsigned int i1){return 0;};

FL_EXPORT unsigned int fl_popup_entry_raise_state( FL_POPUP_ENTRY *P1,
                                                   unsigned int i1){return 0;};

FL_EXPORT unsigned int fl_popup_entry_toggle_state( FL_POPUP_ENTRY *P1,
                                                    unsigned int i1){return 0;};

FL_EXPORT int fl_popup_entry_set_text( FL_POPUP_ENTRY *P1,
                                       const char *c1 ){return 0;};

FL_EXPORT void fl_popup_entry_set_shortcut( FL_POPUP_ENTRY *P1,
                                            const char *c1 ){};

FL_EXPORT long int fl_popup_entry_set_value( FL_POPUP_ENTRY *P1,
                                             long int i1){return 0;};

FL_EXPORT void *fl_popup_entry_set_user_data( FL_POPUP_ENTRY *P1,
                                              void *v1 ){};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_entry_get_by_position( FL_POPUP *P1,
                                                          int i1){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_entry_get_by_value( FL_POPUP *P1,
                                                       long l1){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_entry_get_by_user_data( FL_POPUP *P1,
                                                           void *v1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_entry_get_by_text( FL_POPUP *P1,
                                                      const char *c1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY * fl_popup_entry_get_by_text_f( FL_POPUP *P1,
														 const char *c1,
														 ... ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_popup_entry_get_by_label( FL_POPUP *P1,
                                                       const char *c1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY * fl_popup_entry_get_by_label_f( FL_POPUP *P1,
														  const char *c1,
														  ... ){return NULL;};

FL_EXPORT int fl_popup_entry_get_group( FL_POPUP_ENTRY *P1 ){return 0;};

FL_EXPORT int fl_popup_entry_set_group( FL_POPUP_ENTRY *P1,
                                        int i1){return 0;};

FL_EXPORT FL_POPUP *fl_popup_entry_get_subpopup( FL_POPUP_ENTRY *P1 ){return NULL;};

FL_EXPORT FL_POPUP *fl_popup_entry_set_subpopup( FL_POPUP_ENTRY *PE1,
                                                 FL_POPUP *P1 ){return NULL;};

FL_EXPORT int fl_popup_get_size( FL_POPUP *P1,
                                 unsigned int *i1,
                                 unsigned int *i2 ){return 0;};

FL_EXPORT int fl_popup_get_min_width( FL_POPUP *P1 ){return 0;};

FL_EXPORT int fl_popup_set_min_width( FL_POPUP *P1,
                                      int i1){return 0;};
...
FL_EXPORT int fl_get_browser_topline( FL_OBJECT * ob ){return 0;};

FL_EXPORT int fl_get_browser( FL_OBJECT * ob ){return 0;};

FL_EXPORT int fl_get_browser_maxline( FL_OBJECT * ob ){return 0;};

FL_EXPORT int fl_get_browser_screenlines( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_browser_rel_xoffset( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_browser_rel_yoffset( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_set_default_browser_maxlinelength( int n ){return 0;};

#ifndef FL_BROWSER_SCROLL_CALLBACKt
#define FL_BROWSER_SCROLL_CALLBACKt
typedef void ( * FL_BROWSER_SCROLL_CALLBACK )( FL_OBJECT *o1,
                                               int i1,
                                               void *v1 );
#endif

FL_EXPORT void
    fl_set_browser_hscroll_callback( FL_OBJECT *o1,
                                     FL_BROWSER_SCROLL_CALLBACK CF1,
                                     void *v1 ){};

FL_EXPORT void
    fl_set_browser_vscroll_callback( FL_OBJECT *o1,
                                     FL_BROWSER_SCROLL_CALLBACK CF1,
                                     void *v1 ){};

FL_EXPORT int fl_get_browser_line_yoffset( FL_OBJECT *o1,
										   int i1 ){return 0;};

FL_EXPORT FL_BROWSER_SCROLL_CALLBACK
    fl_get_browser_hscroll_callback( FL_OBJECT *o1 ){};

FL_EXPORT FL_BROWSER_SCROLL_CALLBACK
    fl_get_browser_vscroll_callback( FL_OBJECT *o1 ){};

FL_EXPORT int fl_get_browser_scrollbar_repeat( FL_OBJECT *o1 ){return 0;};

FL_EXPORT void fl_set_browser_scrollbar_repeat( FL_OBJECT *o1,
												int  i1){};
...
FL_EXPORT int fl_get_button( FL_OBJECT * ob ){return 0;};

FL_EXPORT void fl_set_button( FL_OBJECT * ob,
                              int         pushed ){};

FL_EXPORT int fl_get_button_numb( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT FL_HANDLE_CANVAS fl_add_canvas_handler( FL_OBJECT        * ob,
                                                  int                ev,
                                                  FL_HANDLE_CANVAS   h,
                                                  void             * udata ){return NULL;};

FL_EXPORT Window fl_get_canvas_id( FL_OBJECT * ob ){return NULL;};

FL_EXPORT Colormap fl_get_canvas_colormap( FL_OBJECT * ob ){return NULL;};

FL_EXPORT int fl_get_canvas_depth( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_get_choice_maxitems( FL_OBJECT * ob ){return 0;};

FL_EXPORT const char * fl_get_choice_text( FL_OBJECT * ob ){return NULL;};
...
FL_EXPORT int fl_stuff_clipboard( FL_OBJECT            * ob,
                                  ...
                                  const void           * data,
                                  long                   size,
                                  FL_LOSE_SELECTION_CB   lose_callback ){return 0;};

FL_EXPORT int fl_request_clipboard( FL_OBJECT       * ob,
                                    long              type,
                                    FL_SELECTION_CB   got_it_callback ){return 0;};
...
FL_EXPORT int fl_get_counter_precision( FL_OBJECT * ob ){return 0;};

FL_EXPORT void fl_set_counter_return( FL_OBJECT    * ob,
                                      unsigned int   how ){};

FL_EXPORT double fl_get_counter_value( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_counter_repeat( FL_OBJECT * ob ){return 0;};

FL_EXPORT void fl_set_counter_repeat( FL_OBJECT * ob,
                                      int         millisec ){};

FL_EXPORT int fl_get_counter_min_repeat( FL_OBJECT * ob ){return 0;};

FL_EXPORT void fl_set_counter_min_repeat( FL_OBJECT * ob,
                                          int         millisec ){};

FL_EXPORT int fl_get_counter_speedjump( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_dial_value( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT double fl_get_dial_step( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_get_dial_direction( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT const FL_Dirlist * fl_get_dirlist( const char * dir,
                                             const char * pattern,
                                             int        * n,
                                             int          rescan ){return NULL;};

FL_EXPORT FL_DIRLIST_FILTER fl_set_dirlist_filter( FL_DIRLIST_FILTER filter ){};

FL_EXPORT int fl_set_dirlist_sort( int method ){return 0;};

FL_EXPORT int fl_set_dirlist_filterdir( int yes ){return 0;};
...
FL_EXPORT FLPS_CONTROL * flps_init( void ){return NULL;};

FL_EXPORT int fl_object_ps_dump( FL_OBJECT  * ob,
                                 const char * fname ){return 0;};
...
FL_EXPORT FL_FORM *fl_get_formbrowser_topform( FL_OBJECT * ob ){return NULL;};
...
FL_EXPORT int fl_get_formbrowser_xoffset( FL_OBJECT * ob ){return 0;}

FL_EXPORT int fl_get_formbrowser_yoffset( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_formbrowser_numforms( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT void fl_show_message( const char *c1,
                                const char *c2,
                                const char *c3 ){};

FL_EXPORT void fl_show_messages( const char *c1 ){};

#define fl_show_msg fl_show_messages_f
FL_EXPORT void fl_show_messages_f( const char *c1,
								   ... ){};
...
FL_EXPORT int fl_show_question( const char *c1,
                                int i1){return 0;};

FL_EXPORT void fl_hide_question( void ){};

FL_EXPORT void fl_show_alert( const char *c1,
                              const char *c2,
                              const char *c3,
                              int i1){};
...
FL_EXPORT const char * fl_show_input( const char *c1,
                                      const char *c2 ){return NULL;};

FL_EXPORT void fl_hide_input( void ){};

FL_EXPORT const char * fl_show_simple_input( const char *c1,
                                             const char *c2 ){return NULL;};

FL_EXPORT int fl_show_colormap( int i1){return 0;};

/********* choices *****************/

FL_EXPORT int fl_show_choices( const char *c1,
                               int i1,
                               const char *c2,
                               const char *c3,
                               const char *c4,
...
FL_EXPORT int fl_show_choice( const char *c1,
                              const char *c2,
                              const char *c3,
                              int i1,
                              const char *c4,
...
FL_EXPORT void fl_set_choices_shortcut( const char *c1,
                                       const char *c2,
                                       const char *c3 ){};
...
FL_EXPORT void fl_show_oneliner( const char *c1,
                                 FL_Coord C1,
                                 FL_Coord C2){};

FL_EXPORT void fl_hide_oneliner( void ){};

FL_EXPORT void fl_set_oneliner_font( int i1,
                                     int i2){};

FL_EXPORT void fl_set_oneliner_color( FL_COLOR C1,
                                      FL_COLOR C2){};

FL_EXPORT void fl_set_tooltip_font( int i1,
                                    int i2){};

FL_EXPORT void fl_set_tooltip_color( FL_COLOR C1,
                                     FL_COLOR C2){};

FL_EXPORT void fl_set_tooltip_boxtype( int i1){};

FL_EXPORT void fl_set_tooltip_lalign( int i1){};
...
FL_EXPORT FL_PID_T fl_exe_command( const char *c1,
                                   int i1){};

FL_EXPORT int fl_end_command( FL_PID_T P1){return 0;};

FL_EXPORT int fl_check_command( FL_PID_T P1){return 0;};

FL_EXPORT FILE * fl_popen( const char *c1,
                           const char *c2 ){return NULL;};

FL_EXPORT int fl_pclose( FILE * F1){return 0;};

FL_EXPORT int fl_end_all_command( void ){return 0;};

FL_EXPORT void fl_show_command_log( int i1){};

FL_EXPORT void fl_hide_command_log( void ){};

FL_EXPORT void fl_clear_command_log( void ){};

FL_EXPORT void fl_addto_command_log( const char *c1 ){};

FL_EXPORT void fl_addto_command_log_f( const char *c1,
									   ...){};

FL_EXPORT void fl_set_command_log_position( int i1,
                                            int i2){};

FL_EXPORT FD_CMDLOG * fl_get_command_log_fdstruct( void ){return NULL;};
...
FL_EXPORT int fl_use_fselector( int i1){return 0;};

FL_EXPORT const char * fl_show_fselector( const char *c1,
                                          const char *c2,
                                          const char *c3,
                                          const char *c4 ){return NULL;};

//FL_EXPORT void fl_hide_fselector( void ){};

FL_EXPORT void fl_set_fselector_fontsize( int i1){};

FL_EXPORT void fl_set_fselector_fontstyle( int i1){};

FL_EXPORT void fl_set_fselector_placement( int i1){};

FL_EXPORT void fl_set_fselector_border( int i1){};

#define fl_set_fselector_transient( b )   \
            fl_set_fselector_border( ( b ) ? FL_TRANSIENT : FL_FULLBORDER )

FL_EXPORT void fl_set_fselector_callback( FL_FSCB F1,
                                          void *v1 ){};

FL_EXPORT const char * fl_get_filename( void ){return NULL;};

FL_EXPORT const char * fl_get_directory( void ){return NULL;};

FL_EXPORT const char * fl_get_pattern( void ){return NULL;};

FL_EXPORT int fl_set_directory( const char *c1 ){return 0;};

FL_EXPORT void fl_set_pattern( const char *c1 ){};

FL_EXPORT void fl_refresh_fselector( void ){};

FL_EXPORT void fl_add_fselector_appbutton( const char *c1,
                                           void  (*ff)( void * v1),
                                           void *v1 ){};

FL_EXPORT void fl_remove_fselector_appbutton( const char *c1 ){};

FL_EXPORT void fl_disable_fselector_cache( int i1){};

FL_EXPORT void fl_invalidate_fselector_cache( void ){};

FL_EXPORT FL_FORM * fl_get_fselector_form( void ){return NULL;};

FL_EXPORT FD_FSELECTOR * fl_get_fselector_fdstruct( void ){return NULL;};

FL_EXPORT void fl_hide_fselector( void ){};

FL_EXPORT void fl_set_fselector_filetype_marker( int i1,
                                                 int i2,
                                                 int i3,
                                                 int i4,
                                                 int i5){};
...
FL_EXPORT int fl_goodies_atclose( FL_FORM *F1,
                                  void *v1 ){return 0;};
...
FL_EXPORT int fl_get_input_xoffset( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_input_screenlines( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_input_numberoflines( FL_OBJECT * ob ){return 0;};

FL_EXPORT void fl_get_input_format( FL_OBJECT * ob,
                                    int       * fmt,
                                    int       * sep ){};

FL_EXPORT const char * fl_get_input( FL_OBJECT * ob ){return NULL;};
...
FL_EXPORT int fl_validate_input( FL_OBJECT *obj ){return 0;};
...
FL_EXPORT int fl_set_input_mode( int mode ){return 0;};
...
FL_EXPORT int fl_get_menu_popup( FL_OBJECT * ob ){return 0;};

FL_EXPORT int fl_get_menu( FL_OBJECT * ob ){return 0;};

FL_EXPORT const char * fl_get_menu_item_text( FL_OBJECT * ob,
                                              int         numb ){return NULL;};

FL_EXPORT int fl_get_menu_maxitems( FL_OBJECT * ob ){return 0;};

FL_EXPORT unsigned int fl_get_menu_item_mode( FL_OBJECT * ob,
                                              int         numb ){return 0;};

FL_EXPORT const char *fl_get_menu_text( FL_OBJECT * ob ){return NULL;};
...
FL_EXPORT double fl_get_positioner_xvalue( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_positioner_yvalue( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_get_positioner_numb( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT double fl_get_scrollbar_value( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_scrollbar_size( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT FL_OBJECT *fl_create_select( int i1,
                                       FL_Coord C1,
                                       FL_Coord C2,
                                       FL_Coord C3,
                                       FL_Coord C4,
...
FL_EXPORT FL_OBJECT *fl_add_select( int i1,
                                    FL_Coord C1,
                                    FL_Coord C2,
                                    FL_Coord C3,
                                    FL_Coord C4,
...
FL_EXPORT int fl_clear_select( FL_OBJECT *o1 ){return 0;};

FL_EXPORT FL_POPUP_ENTRY *fl_add_select_items( FL_OBJECT  *o1,
                                               const char *c1,
                                               ... ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_insert_select_items( FL_OBJECT *o1,
                                                  FL_POPUP_ENTRY *p1,
                                                  const char     *c1,
                                                  ... ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_replace_select_item( FL_OBJECT *o1,
                                                  FL_POPUP_ENTRY *P1,
                                                  const char *c1,
                                                  ... ){return NULL;};

FL_EXPORT int fl_delete_select_item( FL_OBJECT *o1,
                                     FL_POPUP_ENTRY *p1 ){return 0;};

FL_EXPORT long fl_set_select_items( FL_OBJECT *o1,
                                    FL_POPUP_ITEM *p1 ){return 0;};

FL_EXPORT FL_POPUP *fl_get_select_popup( FL_OBJECT *o1 ){return NULL;};

FL_EXPORT int fl_set_select_popup( FL_OBJECT *o1,
                                   FL_POPUP  *p1 ){return 0;};

FL_EXPORT FL_POPUP_RETURN *fl_get_select_item( FL_OBJECT *o1 ){return NULL;};

FL_EXPORT FL_POPUP_RETURN *fl_set_select_item( FL_OBJECT *o1,
                                               FL_POPUP_ENTRY *p1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_get_select_item_by_value( FL_OBJECT *o1,
                                                       long l1){return NULL;};

FL_EXPORT FL_POPUP_ENTRY *fl_get_select_item_by_label( FL_OBJECT *o1,
                                                       const char *c1 ){return NULL;};

FL_EXPORT FL_POPUP_ENTRY * fl_get_select_item_by_label_f( FL_OBJECT  *o1,
														  const char *c1,
														  ... ){return NULL;};
...
FL_EXPORT FL_POPUP_ENTRY *fl_get_select_item_by_text( FL_OBJECT *o1,
                                                      const char *c1 ){return NULL;};

FL_EXPORT FL_COLOR fl_get_select_text_color( FL_OBJECT *o1 ){};

FL_EXPORT FL_COLOR fl_set_select_text_color( FL_OBJECT *o1,
                                             FL_COLOR c1){};

FL_EXPORT int fl_get_select_text_font( FL_OBJECT *o1,
                                       int *i1,
                                       int *i2 ){return 0;};

FL_EXPORT int fl_set_select_text_font( FL_OBJECT *o1,
                                       int i1,
                                       int i2){return 0;};

FL_EXPORT int fl_get_select_text_align( FL_OBJECT *o1 ){return 0;};

FL_EXPORT int fl_set_select_text_align( FL_OBJECT *o1,
                                        int i1){return 0;};

FL_EXPORT int fl_set_select_policy( FL_OBJECT *o1,
                                    int i1){return 0;};
...
FL_EXPORT double fl_get_slider_value( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_slider_size( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT int fl_get_slider_repeat( FL_OBJECT *o1){return 0;};

FL_EXPORT void fl_set_slider_repeat( FL_OBJECT *o1,
									 int i1){};
...
FL_EXPORT double fl_get_spinner_value( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT double fl_get_spinner_step( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT FL_OBJECT * fl_get_spinner_input( FL_OBJECT * obj ){return NULL;};

FL_EXPORT FL_OBJECT * fl_get_spinner_up_button( FL_OBJECT * obj ){return NULL;};

FL_EXPORT FL_OBJECT * fl_get_spinner_down_button( FL_OBJECT * obj ){return NULL;};
...
FL_EXPORT FL_FORM * fl_get_folder( FL_OBJECT * ob ){return NULL;};

FL_EXPORT int fl_get_folder_number( FL_OBJECT * ob ){return 0;};

FL_EXPORT const char * fl_get_folder_name( FL_OBJECT * ob ){return NULL;};

FL_EXPORT int fl_get_tabfolder_numfolders( FL_OBJECT * ob ){return 0;};

FL_EXPORT FL_FORM * fl_get_active_folder( FL_OBJECT * ob ){return NULL;};

FL_EXPORT int fl_get_active_folder_number( FL_OBJECT * ob ){return 0;};

FL_EXPORT const char * fl_get_active_folder_name( FL_OBJECT * ob ){return NULL;};
...
FL_EXPORT int fl_set_default_tabfolder_corner( int n ){return 0;};

FL_EXPORT int fl_set_tabfolder_offset( FL_OBJECT * obj,
                                       int         offset ){return 0;};

FL_EXPORT int fl_get_tabfolder_offset( FL_OBJECT * obj ){return 0;};
...
FL_EXPORT double fl_get_thumbwheel_value( FL_OBJECT * ob ){return 0;};

FL_EXPORT double fl_set_thumbwheel_value( FL_OBJECT * ob,
                                          double      value ){return 0;};

FL_EXPORT double fl_get_thumbwheel_step( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT double fl_get_timer( FL_OBJECT * ob ){return 0;};
...
FL_EXPORT int fl_setpup_entries( int            nm,
                                 FL_PUP_ENTRY * entries ){return 0;};

FL_EXPORT int fl_newpup( Window win ){return 0;};
...
FL_EXPORT int fl_dopup( int n ){return 0;};
...
FL_EXPORT int fl_setpup_default_fontsize( int size ){return 0;};

FL_EXPORT int fl_setpup_default_fontstyle( int style ){return 0;};
...
FL_EXPORT int fl_setpup_default_bw( int bw ){return 0;};
...
FL_EXPORT int fl_setpup_maxpup( int n ){return 0;};
...
FL_EXPORT int fl_getpup_items( int n ){return 0;};

FL_EXPORT int fl_current_pup( void ){return 0;};

#define fl_setpup_hotkey    fl_setpup_shortcut

FL_EXPORT FL_PUP_CB fl_setpup_itemcb( int        nm,
                                      int       ni,
                                      FL_PUP_CB cb ){return NULL;};
...
FL_EXPORT FL_XYPLOT_SYMBOL fl_set_xyplot_symbol( FL_OBJECT        * ob,
                                                 int                id,
                                                 FL_XYPLOT_SYMBOL   symbol ){return NULL;};
...
FL_EXPORT int fl_fheight_( void ){return 0;};
FL_EXPORT int fl_fdesc_( void ){return 0;};
